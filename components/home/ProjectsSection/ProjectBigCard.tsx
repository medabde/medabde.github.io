  ...
  return (
    <>
      <ScrollReveal className="hidden md:block h-full col-span-2 row-span-2">
        <div className="h-full  bg-gray-100 dark:bg-palette-light-secondary dark:text-gray-300 hover:dark:shadow-gray-600 p-6 rounded-sm hover:shadow-gray-400 shadow-lg flex flex-col justify-between transition-shadow animate-ease-in">
